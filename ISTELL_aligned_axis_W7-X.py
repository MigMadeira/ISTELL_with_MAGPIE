...
input_name = 'wout_W7-X_standard_configuration_rescaled_B=46G.nc'
...
#OUT_DIR = 'ISTELL_aligned_axis/2cm_diag_backtracking/'
OUT_DIR = 'ISTELL_aligned_axis/W7-X_2cm_B=46G/' 
...
base_currents = [Current(1.0) * 6.624e3 for i in range(ncoils)]
...
kwargs['K'] = 10400 #10400 # Maximum number of GPMO iterations to run
