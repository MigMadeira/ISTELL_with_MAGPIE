...
coilfile = "./ISTELL_aligned_axis/2cm_no_diagnostics_no_quadrupole_fixed_I=72kA/biot_savart_initial.json"
famus_filename = "./ISTELL_aligned_axis/2cm_no_diagnostics_no_quadrupole_fixed_I=72kA/SIMSOPT_dipole_solution.focus"
dipole_file = "./ISTELL_aligned_axis/2cm_no_diagnostics_no_quadrupole_fixed_I=72kA/best_result_m=2520.txt"
...
np.save(OUT_DIR+f"Poincare_data_tol={tol_poincare}_t={tmax_fl}_2cm_no_diagnostics_no_quadrupole_fixed_I=72kA",Poincare_data)
