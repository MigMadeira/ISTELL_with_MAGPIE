...
coilfile = "./ISTELL_aligned_axis/2cm_diag_2/biot_savart_initial.json"
famus_filename = "./ISTELL_aligned_axis/2cm_diag_2/SIMSOPT_dipole_solution.focus"
dipole_file = "./ISTELL_aligned_axis/2cm_diag_2/best_result_m=9984.txt"
