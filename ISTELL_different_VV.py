...
cylinder_list = [sopp.Cylinder(0.52+0.01, 0.06, 2*np.pi/12, np.pi/2, 0.21, 0.0575, 2*np.pi/12, 0),
                 ...
                 sopp.Cylinder(0.52, 0.03, 4*np.pi/12, 5*np.pi/18, 0.21, 0.0575, 4*np.pi/12, np.pi/2)]
